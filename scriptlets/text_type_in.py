...
class TextTypeIn(Scriptlet):
    ...
    def _clear_mach(self, **kwargs):
        self.machine.variables.set_machine_var(name="thePinExp", value="")
        self.machine.variables.set_machine_var(name="s1", value="")
        self.machine.variables.set_machine_var(name="s2", value="")
        self.machine.variables.set_machine_var(name="s3", value="")
        self.machine.variables.set_machine_var(name="s4", value="")
        self.machine.variables.set_machine_var(name="s5", value="")
        self.machine.variables.set_machine_var(name="s6", value="")

    def _set_text(self, **kwargs):
        TextTypeIn.textValue = kwargs.get("text")

        if TextTypeIn.textValue == "s6":
            #TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score6_label")) + "-" + str(self.machine.variables.get_machine_var("score6_name")) + " " + str(self.machine.variables.get_machine_var("score6_value"))
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score6_label")) + "-" + str(self.machine.variables.get_machine_var("score6_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score6_value"))

        if TextTypeIn.textValue == "s5":
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score5_label")) + "-" + str(self.machine.variables.get_machine_var("score5_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score5_value"))

        if TextTypeIn.textValue == "s4":
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score4_label")) + "-" + str(self.machine.variables.get_machine_var("score4_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score4_value"))

        if TextTypeIn.textValue == "s3":
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score3_label")) + "-" + str(self.machine.variables.get_machine_var("score3_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score3_value"))

        if TextTypeIn.textValue == "s2":
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score2_label")) + "-" + str(self.machine.variables.get_machine_var("score2_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score2_value"))

        if TextTypeIn.textValue == "s1":
            TextTypeIn.textValue = str(self.machine.variables.get_machine_var("score1_label")) + "-" + str(self.machine.variables.get_machine_var("score1_name")) + " " + "{:,}".format(self.machine.variables.get_machine_var("score1_value"))
        ...
        self.machine.variables.set_machine_var(name=TextTypeIn.varName, value=TextTypeIn.textDisplay)
        self.machine.delay.add(callback=self._text_timer, ms=TextTypeIn.delayMs)
